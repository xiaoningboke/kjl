...
$(function () {
    ...
    (function () {
       ...
       //     if (this === nav_on) return;   //2016.1.7
		...
		//$("#nav li a").eq(1).attr('idx', "1");   //2016.1.7
            }, function () {
		control(link_page, true);
		//$(".g-wrap div").eq(0).removeClass('on');  //2016.1.7
		// $(".g-wrap div").removeClass('on');  //2016.1.7
            });
        });
        ...
        function control(elem, flag, idx) {
            ...
            if (flag) {
                ...
                prev_item = subitem.eq(idx-1).addClass('on');
                // search_box.hide();
