...
<!-- 关于我们 -->
<!DOCTYPE html>
<html><style type="text/css" id="259270874195"></style><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<head>
<style>
.wordfont{
font-size: 12px;
...
.hzhbtr{
    height:130px;
           ...
           <link rel="stylesheet" type="text/css" href="/kjl/themes/simplebootx/Public/about/css/inner.css">
           <link rel="stylesheet" type="text/css" href="/kjl/themes/simplebootx/Public/about/css/hover-effects.css">
    <!-- 首页 -->
<!DOCTYPE html>
<!--首页-->
    <html>
...
<link rel="stylesheet" type="text/css" href="/kjl/themes/simplebootx/Public/about/css/basic.css">

<script type="text/javascript">document.getElementById("menu2").className="a1";</script>
<!-- 大图 -->
<div style="height: 60px"></div>
<div >
  <img src="/kjl/public/images/bag1.jpg" alt="康吉诺(北京)科技有限公司"  class="big" >
</div>
<div class="container">
...
<!-- 公司简介 -->
  <div class="general">
    <div class="general_con">
      ...
      <div class="box_parent" id="box_parentab">
        <div class="box1  box-l J_Box" init="true" id='gsjjt'><img src="/kjl/themes/simplebootx/Public/about/img/Join1.jpg" width="600px" height="400px"></div>
        <div class="general_con_c_ri  box-r J_Box" init="true" id="gsjjw">
         
           <div class="general_con_c_ri_word" id="gsjjs"><font class="wordfont"><?php echo ($gsjj[0][about_content]); ?></font></div>
...
<tr>
<?php $t=0 ?>
<?php if(is_array($gsry)): foreach($gsry as $key=>$vo): ?><td><div class="tv_hot fl" >
                    <font class="avatar" target="_blank" title="康吉诺(北京)科技有限公司">
                    <img width="280" height="205" src="/kjl/themes/simplebootx/Public/about/img/<?php echo ($vo["about_address"]); ?>" alt="康吉诺(北京)科技有限公司">
                    </font>
            </div></td>
<?php $t++; if($t%3==0){ echo "</tr>"; echo "<tr>"; } endforeach; endif; ?>
...
<table align="center">
  <tr>
  <?php $m=0; ?>
    <?php if(is_array($zzrz)): foreach($zzrz as $key=>$vo): ?><td>
      <div class="qcontainer">
    <div class="film">
      <div class="face front"><img class="zz" src="/kjl/themes/simplebootx/Public/about/img/<?php echo ($vo["about_address"]); ?>" ></div>
      <div class="face back"><img class="zz" src="/kjl/themes/simplebootx/Public/about/img/<?php echo ($vo["about_address"]); ?>"></div>
    </div>
  </div>
    </td>
    <?php $m++; if($m%4==0){ echo "</tr>"; echo "<tr>"; } endforeach; endif; ?>
...
<!-- 合作伙伴 -->
  ...
  <?php if(is_array($data)): foreach($data as $key=>$vo): ?><td>
        ...
        <div class=" " id="hhhh">
          <div class="">
            <img src="/kjl/themes/simplebootx/Public/about/img/<?php echo ($vo["about_address"]); ?>" alt="" width="80" height="80">
          </div>
          <div class="">
            <h4><?php echo ($vo["about_title"]); ?></h4>
          </div>
        </div>
  ...
  <?php $i++; if($i%5==0){ echo "</tr>"; echo "<tr class='hzhbtr'>"; } endforeach; endif; ?>
        </table>
        </div>
      </div>
    </div>
