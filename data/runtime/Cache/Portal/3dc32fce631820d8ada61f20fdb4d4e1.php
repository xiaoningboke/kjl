...
<link rel="stylesheet" href="/kjl/themes/simplebootx/Public/mystyle/css/style.css" type="text/css">
...
<!-- 无缝滚动代码 -->
            ...
            <?php if(is_array($lists['posts'])): $i = 0; $__LIST__ = $lists['posts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $smeta=json_decode($vo['smeta'], true); ?>
                    <li onclick='location.href ="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>"'>
                                <img src="<?php echo sp_get_asset_upload_path($smeta['thumb']);?>" alt="<?php echo ($vo["post_title"]); ?>"  style="height:200px;width:200px;" >
                        <dd>
                        <?php echo ($vo["post_title"]); ?>
                        </dd>
                        <!-- <p><?php echo ($vo["index_content"]); ?></p>
                        <a href="#"></a> -->
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
<!-- 无缝滚动代码 -->
                </ul>
            </div>
            <div class="but_left"><img src="/kjl/themes/simplebootx/Public/mystyle/img/qianxleft.png"></div>
            <div class="but_right"><img src="/kjl/themes/simplebootx/Public/mystyle/img/qianxr.png"></div>
          </div>
    </div>
</div>

<script type="text/javascript" src="/kjl/themes/simplebootx/Public/mystyle/js/jquery.js"></script>
