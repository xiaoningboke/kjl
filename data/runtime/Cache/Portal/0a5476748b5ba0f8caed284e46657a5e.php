...
$(function(){
    ...
    <script src="/themes/simplebootx/Public/assets/js/jquery-3.1.1.min.js"></script>
<img src="/public/images/bag5.jpg" class="big">
    ...
    <ul class="nav nav-list">
      ...
      <link href="/themes/simplebootx/Public/join/css/position.css" rel="stylesheet">
<div id="main">
    <div class="table-responsive">
             <?php if(is_array($position)): $i = 0; $__LIST__ = $position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><table class="table table-bordered" width="1200" id="join-table">
          <tbody>
                <tr>
                <input type="hidden" name="joinid">
                    <td class="category active tdalign"><font>职位类型：</font></td>
                    <td><font><?php echo ($position["position_type"]); ?></font></td>
                    <td class="category active tdalign"><font>职位名称：</font></td>
                    <td><font><?php echo ($position["position_name"]); ?></font></td>
                </tr>
                 <tr>
                    <td class="category active tdalign"><font>招聘人数：</font></td>
                    <td><font><?php echo ($position["position_number"]); ?></font</td>
                    <td class="category active tdalign"><font>性别：</font></td>
                    <td>
                    <?php switch($position["position_sex"]): case "2": ?><font>不限</font><?php break;?>
                            <?php case "0": ?><font>女</font><?php break;?>
                            <?php case "1": ?><font>男</font><?php break;?>
                            <?php default: ?><font>性别</font><?php endswitch;?>
                </td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>工作性质：</font</td>
                    <td><font><?php echo ($position["position_nature"]); ?></font</td>
                    <td class="category active tdalign">薪水范围：</font</td>
                    <td><font><?php echo ($position["position_salary"]); ?></font</td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>学历要求：</font</td>
                    <td>
                    <?php switch($position["position_education"]): case "0": ?><font>中专及以上</font><?php break;?>
                            <?php case "1": ?><font>高中</font><?php break;?>
                            <?php case "2": ?><font>专科</font><?php break;?>
                            <?php case "3": ?><font>本科</font><?php break;?>
                            <?php case "4": ?><font>硕士</font><?php break;?>
                            <?php case "5": ?><font>博士及以上</font><?php break;?>
                            <?php default: ?>性别<?php endswitch;?>
                    </td>
                    <td class="category active tdalign"><font>工作地区：</font</td>
                    <td><font><?php echo ($position["position_district"]); ?></font</td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>工作部门：</font</td>
                    <td><font><?php echo ($position["position_section"]); ?></font</td>
                    <td class="category active tdalign"><font>工作年限：</font</td>
                    <td>
                        <?php switch($position["position_year"]): case "0": ?><font>应届毕业生</font><?php break;?>
                            <?php case "1": ?><font>在校大学生</font><?php break;?>
                            <?php case "2": ?><font>1年以上</font><?php break;?>
                            <?php case "3": ?><font>2年以上</font><?php break;?>
                            <?php case "4": ?><font>3年以上</font><?php break;?>
                            <?php case "5": ?><font>5年以上</font><?php break;?>
                            <?php case "6": ?><font>8年以上</font><?php break;?>
                            <?php case "7": ?><font>10年以上</font><?php break;?>
                            <?php default: ?>工作年限<?php endswitch;?>
                   </td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>年龄要求：</font</td>
                    <td><font><?php echo ($position["position_age"]); ?></font</td>
                    <td class="category active tdalign"><font>职位标记：</font</td>
                    <td><font><?php echo ($position["position_tag"]); ?></font</td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>发布日期：</font</td>
                    <td><font><?php echo ($position["position_release"]); ?></font</td>
                    <td class="category active tdalign"><font>截止日期：</font</td>
                    <td><font><?php echo ($position["position_abort"]); ?></font</td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>职位描述：</font</td>
                    <td colspan="3"><font><?php echo ($position["position_describe"]); ?></font</td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>能力要求：</font</td>
                    <td colspan="3"><font><?php echo ($position["position_require"]); ?></font</td>
                 </tr>
                 <tr>
                    <td class="category active tdalign"><font>其他说明：</font</td>
                    <td colspan="3"><font><?php echo ($position["position_other"]); ?></font</td>
                 </tr><?php endforeach; endif; else: echo "" ;endif; ?>
          </tbody>
        </table>
    </div>
    <div align="center">
          <a class="btn btn-default" href="<?php echo U('Portal/Join/immediatelyapply',array('nameid'=>$id));?>" role="button" style="margin-right: 50px;"><font>立刻申请该职位</font></a>
          <a class="btn btn-default" href="<?php echo U('Portal/Join/index');?>" role="button"><font>返回</font></a>
    </div>
