...
<!--  -->
<link href="/kjl/themes/simplebootx/Public/article/css/leftcontant.css" rel="stylesheet">
<!--  -->
<style>
  .big{
    height:274px;
...
<div>
	<img src="/kjl/public/images/bag3.jpg" alt="康吉诺(北京)科技有限公司" class="big">
</div>
   		...
   		<tr>
			...
			<div class="">
				...
				<div class="list-boxes">
					<h4 ><a href="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>"><?php echo ($vo["post_title"]); ?></a></h4>
					<p><font><?php echo (msubstr($vo["post_excerpt"],0,256)); ?></font></p>
					<div>
						<div class="pull-left">
							<div class="list-actions">
							<a href="javascript:;" id="signcolor"><i class="fa fa-eye"></i><span><font><?php echo ($vo["post_hits"]); ?></font></span></a>

							</div>
						</div>
						<a class="btn  pull-right" id="lookmore" href="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>">查看更多</a>
					</div>
				</div><?php endforeach; endif; else: echo "" ;endif; ?>

			</div>
			<div class="pagination"><ul><font><?php echo ($lists['page']); ?></font></ul></div>
		</div>
			        	...
			        	<dl class="dl-horizontal">
				            <dt>
					            <a class="img-wraper" href="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>">
					            	<?php if(empty($smeta['thumb'])): ?><img src="/kjl/themes/simplebootx/Public/assets/images/default_tupian4.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
									<?php else: ?>
				            ...
				            <dd style="margin:15px 0 0 -2px;"><a href="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>"><?php echo msubstr($vo['post_title'],0,32);?></a></dd>
