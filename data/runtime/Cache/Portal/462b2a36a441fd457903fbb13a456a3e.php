...
<img src="/kjl/public/images/bag2.jpg" alt="康吉诺(北京)科技有限公司" class="big">
    <div class="container">
            ...
            <div class="item">
                <div class="tc-gridbox" style="height:395px; ">
                    <div class="header" >
                        ...
                        <?php if(!empty($smeta['thumb'])): ?><div class="item-image" style="height:260px;">
                    ...
                    <div class="footer">
                        ...
                        <div class="pull-right">
                            <a href="javascript:;" class="signcolor"><i class="fa fa-eye"></i><span><?php echo ($vo["post_hits"]); ?></span></a>
...
$(function(){
    ...
    <script src="/kjl/themes/simplebootx/Public/assets/js/imagesloaded.pkgd.min.js"></script>
    <script src="/kjl/themes/simplebootx/Public/assets/js/masonry.pkgd.min.js"></script>
    <script src="/kjl/themes/simplebootx/Public/assets/js/jquery.infiniteScroll.js"></script>
    <script>
