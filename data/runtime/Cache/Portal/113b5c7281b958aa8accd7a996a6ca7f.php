...
$(function(){
    ...
    <script src="/kjl/themes/simplebootx/Public/assets/js/jquery-3.1.1.min.js"></script>
<img src="/kjl/public/images/bag5.jpg" class="big">
    ...
    <ul class="nav nav-list">
      ...
      <link href="/kjl/themes/simplebootx/Public/join/css/join.css" rel="stylesheet">
<div id="main">
<div id="top"></div>
    <div class="table-responsive">
        <table class="table table-hover table-bordered table-striped" width="800px" id="join-table">
          <thead>
            <tr class="info">
                        <th><font>职位名称</font></th>
                        <th><font>职位类型</font></th>
                        <th><font>工作年限</font></th>
                         <th><font>薪水范围</font></th>
                        <th><font>招聘人数</font></th>
                        <th><font>工作地区</font></th>
                        <th><font>学历要求</font></th>
                        <th><font>发布时间</font></th>
                        <th><font>申请职位</font></th>
            </tr>
          </thead>
          <tbody>
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><a href="<?php echo U('Portal/Join/position',array('id'=>$vo['id']));?>"><font><?php echo ($vo["join_title"]); ?></font></a></td>
                            <td><a href="<?php echo U('Portal/Join/type',array('id'=>$vo['id']));?>"><font><?php echo ($vo["join_type"]); ?></font></a></td>
                            <td>
                            <?php switch($vo["join_agelimit"]): case "0": ?><font>应届毕业生</font><?php break;?>
                                ...
                                <?php case "8": ?><font>不限</font><?php break;?>
                                <?php default: ?><font>工作年限</font><?php endswitch;?>

                            </td>
                            <td><font><?php echo ($vo["join_pay"]); ?></font></td>
                            <td><font><?php echo ($vo["join_number"]); ?></font></td>
                            <td><font><?php echo ($vo["join_district"]); ?></font></td>
                            <td>
                            <?php switch($vo["join_education"]): case "0": ?><font>中专及以上</font><?php break;?>
                            ...
                            <?php default: ?><font>学历要求</font><?php endswitch;?>
                            </td>
                            <td><font><?php echo ($vo["join_time"]); ?></font></td>
                            <td><a href="<?php echo U('Portal/Join/apply',array('id'=>$vo['id']));?>"><font>申请职位</a></td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
          </tbody>
        </table>
    </div>

    <nav aria-label="Page navigation" id="navlabel">
<input type="hidden" id="hidden" name="field＿name" value="<?php echo ($page); ?>"><font>
      <ul class="pagination">
        <li>
        <?php if($limit<=1){ $start = 1; }else{ $start = $limit-1; } ?>

          <a href="<?php echo U('Portal/Join/index',array('page'=>$start));?>" aria-label="Previous" id="insert-a">
            <span aria-hidden="true">&laquo;</span>
          </a>

         <?php for($i = 1;$i<=$page;$i++) { $url = U('Portal/Join/index',array('page'=>$i)); echo '<li><a href="'.$url.'">'.$i.'</a></li>'; } ?>
            <?php if($limit>=$page){ $end = $page; }else{ $end = $limit+1; } ?>
          <li><a href="<?php echo U('Portal/Join/index',array('page'=>$end));?>" id="Next">&raquo;</a></li>
        </li>
      </ul>
    </nav>
    <br/><br/>
